             ...
             ignoreCase:(BOOL)ignoreCase
{
    ...
    else if (textField.autocompleteType == HTAutocompleteTypeColor)
    {
        ...
        {
            colorAutocompleteArray = self.allAllergiesArray;
...
//- (void)callApiForAllergiesData: (NSString *)text {
//        
//    NSString * apiName = [kAPIForAutoAllergies stringByAppendingString:text];
//    
//    [ServiceHelper request:[NSMutableDictionary dictionary] apiName:apiName method:GET completionBlock:^(NSDictionary *resultDict, NSError *error) {
//        
//        if (!error) {
//            
...
//                
//                dataArray = [resultDict objectForKeyNotNull:pData expectedObj:[NSArray array]];
//                
//      
//                
//            }
